...
project.ext.set("publishArtifactId", "aniflux-gif")
project.ext.set("publishVersion", rootProject.ext.get("anifluxVersion") as String)

android {
    namespace = "com.kernelflux.aniflux.gif"
...
dependencies {
    ...
    debugApi(project(":animLibs:android-gif-drawable"))
    kspDebug(project(":aniflux-compiler-ksp"))


    releaseApi(libs.aniflux.gif.lib)
