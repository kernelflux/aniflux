...
project.ext.set("publishArtifactId", "aniflux-lottie")
project.ext.set("publishVersion", rootProject.ext.get("anifluxVersion") as String)

android {
    namespace = "com.kernelflux.aniflux.lottie"
...
dependencies {
    ...
    debugApi(project(":animLibs:lottie"))
    kspDebug(project(":aniflux-compiler-ksp"))


    releaseApi(libs.aniflux.lottie.lib)
