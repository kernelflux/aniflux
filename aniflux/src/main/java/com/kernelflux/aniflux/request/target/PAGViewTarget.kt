 ...
 * @date: 2025/01/XX
 */
class PAGViewTarget(view: PAGImageView) : CustomViewAnimationTarget<PAGImageView, PAGFile>(view) {
 ...
 */
class PAGViewTargetForPAGView(view: PAGView) : CustomViewAnimationTarget<PAGView, PAGFile>(view) {
