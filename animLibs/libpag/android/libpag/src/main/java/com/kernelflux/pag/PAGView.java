...
import com.kernelflux.pag.extra.tools.Lifecycle;
import com.kernelflux.pag.extra.tools.LifecycleListener;
...
public class PAGView extends TextureView implements TextureView.SurfaceTextureListener,
     ...
     */
    public void play() {
        // 关键修复：如果 duration 为 0，延迟启动
        // 避免竞态条件：setComposition() 后立即调用 play() 时，duration 可能还是 0
        // 或者 isVisible = false 时，duration 没有被设置
