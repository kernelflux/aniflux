...
extern "C" jint JNI_OnLoad(JavaVM *vm, void *) {
    LOGI("ANIFLUX PAG JNI_OnLoad Version: %s", pag::PAG::SDKVersion().c_str());
...
namespace pag {
    ...
    jobject MakePAGFontObject(JNIEnv *env, const std::string &familyName,
        ...
        static Global<jclass> PAGFontClass = env->FindClass("com/kernelflux/pag/PAGFont");
    ...
    jobject MakeByteBufferObject(JNIEnv *env, const void *bytes, size_t length) {
        ...
        auto result = env->CallStaticObjectMethod(ByteBufferClass.get(), ByteBuffer_wrap,
                                                  byteArray);
    ...
    jobjectArray ToPAGLayerJavaObjectList(JNIEnv *env,
        ...
        static Global<jclass> PAGLayer_Class = env->FindClass("com/kernelflux/pag/PAGLayer");
    ...
    jobject ToPAGLayerJavaObject(JNIEnv *env, std::shared_ptr<pag::PAGLayer> pagLayer) {
        ...
        switch (pagLayer->layerType()) {
            case pag::LayerType::Shape: {
                static Global<jclass> PAGLayer_Class = env->FindClass(
                        "com/kernelflux/pag/PAGShapeLayer");
                static auto PAGLayer_Constructor = env->GetMethodID(PAGLayer_Class.get(), "<init>",
                                                                    "(J)V");
                layerObject = env->NewObject(PAGLayer_Class.get(), PAGLayer_Constructor,
                                             reinterpret_cast<jlong>(new JPAGLayerHandle(
                                                     pagLayer)));
                break;
            }
            case pag::LayerType::Solid: {
                static Global<jclass> PAGLayer_Class = env->FindClass(
                        "com/kernelflux/pag/PAGSolidLayer");
                static auto PAGLayer_Constructor = env->GetMethodID(PAGLayer_Class.get(), "<init>",
                                                                    "(J)V");
                layerObject = env->NewObject(PAGLayer_Class.get(), PAGLayer_Constructor,
                                             reinterpret_cast<jlong>(new JPAGLayerHandle(
            ...
            case pag::LayerType::PreCompose: {
                if (std::static_pointer_cast<pag::PAGComposition>(pagLayer)->isPAGFile()) {
                    static Global<jclass> PAGLayer_Class = env->FindClass(
                            "com/kernelflux/pag/PAGFile");
                    static auto PAGLayer_Constructor = env->GetMethodID(PAGLayer_Class.get(),
                                                                        "<init>", "(J)V");
                    layerObject = env->NewObject(PAGLayer_Class.get(), PAGLayer_Constructor,
                                                 reinterpret_cast<jlong>(new JPAGLayerHandle(
                                                         pagLayer)));
                    ...
                    static Global<jclass> PAGLayer_Class = env->FindClass(
                            "com/kernelflux/pag/PAGComposition");
                    static auto PAGLayer_Constructor = env->GetMethodID(PAGLayer_Class.get(),
                                                                        "<init>", "(J)V");
                    layerObject = env->NewObject(PAGLayer_Class.get(), PAGLayer_Constructor,
                                                 reinterpret_cast<jlong>(new JPAGLayerHandle(
            ...
            case pag::LayerType::Text: {
                static Global<jclass> PAGLayer_Class = env->FindClass(
                        "com/kernelflux/pag/PAGTextLayer");
                static auto PAGLayer_Constructor = env->GetMethodID(PAGLayer_Class.get(), "<init>",
                                                                    "(J)V");
                layerObject = env->NewObject(PAGLayer_Class.get(), PAGLayer_Constructor,
                                             reinterpret_cast<jlong>(new JPAGLayerHandle(
            ...
            case pag::LayerType::Image: {
                static Global<jclass> PAGLayer_Class = env->FindClass(
                        "com/kernelflux/pag/PAGImageLayer");
                static auto PAGLayer_Constructor = env->GetMethodID(PAGLayer_Class.get(), "<init>",
                                                                    "(J)V");
                layerObject = env->NewObject(PAGLayer_Class.get(), PAGLayer_Constructor,
                                             reinterpret_cast<jlong>(new JPAGLayerHandle(
    ...
    std::shared_ptr<pag::PAGLayer> ToPAGLayerNativeObject(JNIEnv *env, jobject jLayer) {
        ...
        static auto PAGLayer_nativeContext = env->GetFieldID(PAGLayer_Class.get(), "nativeContext",
                                                             "J");

        auto nativeContext =
                reinterpret_cast<JPAGLayerHandle *>(env->GetLongField(jLayer,
                                                                      PAGLayer_nativeContext));
    ...
    std::shared_ptr<pag::PAGComposition> ToPAGCompositionNativeObject(JNIEnv *env,
        ...
        static Global<jclass> PAGComposition_Class = env->FindClass(
                "com/kernelflux/pag/PAGComposition");
    ...
    jobject ToPAGVideoRangeObject(JNIEnv *env, const pag::PAGVideoRange &range) {
        ...
        static Global<jclass> PAGVideoRange_Class = env->FindClass(
                "com/kernelflux/pag/PAGVideoRange");
