...
public enum ReducedMotionMode {
   ...
   * By default this mode is used when {@link com.kernelflux.lottie.utils.Utils#getAnimationScale(Context)} is not 0.
   */
  STANDARD_MOTION,

  /**
   * Lottie animations with a "reduced motion" marker will play that marker instead of any other animations.
   * By default this mode is used when {@link com.kernelflux.lottie.utils.Utils#getAnimationScale(Context)} == 0.
   */
  REDUCED_MOTION
}
