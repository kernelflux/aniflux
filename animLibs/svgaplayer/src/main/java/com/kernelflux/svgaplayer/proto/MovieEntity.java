...
public final class MovieEntity extends Message<MovieEntity, MovieEntity.Builder> {
  ...
  @WireField(
      tag = 2,
      adapter = "com.kernelflux.svgaplayer.MovieParams#ADAPTER"
  )
  ...
  @WireField(
      tag = 4,
      adapter = "com.kernelflux.svgaplayer.SpriteEntity#ADAPTER",
  ...
  @WireField(
      tag = 5,
      adapter = "com.kernelflux.svgaplayer.AudioEntity#ADAPTER",
      label = WireField.Label.REPEATED
  )
