...
package com.kernelflux.svgaplayer.proto;
...
public final class ShapeEntity extends Message<ShapeEntity, ShapeEntity.Builder> {
  ...
  @WireField(
      tag = 1,
      adapter = "com.kernelflux.svgaplayer.ShapeEntity$ShapeType#ADAPTER"
  )
  ...
  @WireField(
      tag = 10,
      adapter = "com.kernelflux.svgaplayer.ShapeEntity$ShapeStyle#ADAPTER"
  )
  ...
  @WireField(
      tag = 11,
      adapter = "com.kernelflux.svgaplayer.Transform#ADAPTER"
  )
  public final Transform transform;

  @WireField(
      tag = 2,
      adapter = "com.kernelflux.svgaplayer.ShapeEntity$ShapeArgs#ADAPTER"
  )
  public final ShapeArgs shape;

  @WireField(
      tag = 3,
      adapter = "com.kernelflux.svgaplayer.ShapeEntity$RectArgs#ADAPTER"
  )
  public final RectArgs rect;

  @WireField(
      tag = 4,
      adapter = "com.kernelflux.svgaplayer.ShapeEntity$EllipseArgs#ADAPTER"
  )
  ...
  public static final class ShapeStyle extends Message<ShapeStyle, ShapeStyle.Builder> {
    ...
    @WireField(
        tag = 1,
        adapter = "com.kernelflux.svgaplayer.ShapeEntity$ShapeStyle$RGBAColor#ADAPTER"
    )
    ...
    @WireField(
        tag = 4,
        adapter = "com.kernelflux.svgaplayer.ShapeEntity$ShapeStyle$LineCap#ADAPTER"
    )
    ...
    @WireField(
        tag = 5,
        adapter = "com.kernelflux.svgaplayer.ShapeEntity$ShapeStyle$LineJoin#ADAPTER"
    )
