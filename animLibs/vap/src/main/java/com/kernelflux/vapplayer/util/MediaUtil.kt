 ...
 */
package com.kernelflux.vapplayer.util
...
object MediaUtil {
    ...
    fun checkSupportCodec(mimeType: String): Boolean {
        ...
        return supportTypeMap.containsKey(mimeType.lowercase(Locale.getDefault()) )
    }
        ...
        try {
            ...
            for (i in 0 until numCodecs) {
                ...
                for (j in types.indices) {
                    val key = types[j].lowercase(Locale.getDefault())
                    supportTypeMap[key] = true
                }
            }
